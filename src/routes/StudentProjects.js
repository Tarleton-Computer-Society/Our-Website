...
import egui from '../assets/images/egui.png';
...
<img src={bannerimg} alt="" />
    ...
    <h1 className="text-purple">Individual Projects</h1>
    <span> Showcasing the innovative  projects developed by the Tarleton Computer Society</span>
    </div>

     <div className="projects-list">
        <div className="indv-project sp">
        <div className="header">
            <div className="logo">
                <img src={egui} className='plogo' alt="" />
            </div>
            <div className="text">
                <label htmlFor="">Encode GUI</label>
                <p>EncodeGUI (encode-gooey) is a free and open-source video transcoding software.</p>
            </div>
